...
# Video parameters
cap = cv2.VideoCapture("ir_input_video.mp4")
...
while True:
    ...
    # Every 30 seconds (i.e., after frames_per_epoch frames), sample and form a clip
    if frame_counter % frames_per_epoch == 0:
        epoch_clip = sample_epoch_frames(clip_frames, 16)
        ...
        # At this point, you can use clip_tensor for training your model.
        # For debugging, you might also convert these tensors back to images and save them.
        clip_frames = []
